...
public class AcceptTest10 {
	...
	public void testMain() throws IOException {
		...
		//設定從鍵盤依序輸入"985002010\n", "T\n", "Q\n, "E\n, "Q\n""		
		ByteArrayInputStream  inContent = new ByteArrayInputStream("985002010\nT\nQ\nE\nQ\n". getBytes());
		...
		//比對螢幕輸出	
		assertThat(outContent.toString(), containsString("Welcome 楊君山 ! "));
		...
		assertThat(outContent.toString(), containsString("指令錯了!"));
		assertThat(outContent.toString(), containsString("使用者輸入："));
		assertThat(outContent.toString(), containsString("指令錯了!"));
		assertThat(outContent.toString(), containsString("使用者輸入："));
